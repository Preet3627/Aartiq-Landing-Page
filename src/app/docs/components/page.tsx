...
const desktopCategories: CategorySection[] = [
  {
    ...
    components: [
      { name: "AIChatSidebar", lines: 5046, description: "Main chat interface with real-time streaming, thinking indicators, command execution, and scheduling.", tags: ["React", "AI", "Main"] },
      { name: "AIUtils", lines: 1046, description: "Utility functions for PDF generation, image handling, command formatting, and secure storage.", tags: ["React", "Utils"] },
      { name: "AIConstants", lines: 624, description: "AI instructions, commands, capabilities, language maps, and system prompts.", tags: ["React", "Config"] },
      { name: "SchedulingModal", lines: 494, description: "Modal for scheduling AI tasks with cron builder, model selection, and notification options.", tags: ["React", "AI"] },
      { name: "AISetupGuide", lines: 474, description: "Interactive wizard for configuring AI providers and API keys with validation.", tags: ["React", "Setup"] },
      { name: "SchedulingIntentDetector", lines: 368, description: "Natural language scheduling detection with cron expression extraction.", tags: ["React", "AI"] },
      { name: "SecureDOMReader", lines: 671, description: "Secure DOM reading with XSS prevention and structured data extraction.", tags: ["React"] },
      { name: "DOMSearchDisplay", lines: 359, description: "Visual DOM search results with element highlighting and metadata.", tags: ["React"] },
      { name: "AICommandQueue.tsx", lines: 405, description: "Queue management for AI commands with priority and retry logic.", tags: ["React", "AI"] },
      { name: "RobustParsers", lines: 224, description: "Robust JSON/shell output parsing with regex fallbacks for AI responses.", tags: ["React"] },
      { name: "ClickPermissionModal", lines: 222, description: "Permission dialog for click actions with risk assessment.", tags: ["React"] },
      { name: "CollapsibleOCRMessage", lines: 216, description: "Expandable OCR results display with raw text view and confidence scores.", tags: ["React", "OCR"] },
      { name: "AIAssistOverlay.tsx", lines: 281, description: "Floating AI assistant overlay for contextual help.", tags: ["React", "AI"] },
      { name: "FlowchartDiagram", lines: 256, description: "Interactive flowchart rendering with zoom, pan, and node editing.", tags: ["React"] },
      { name: "ThinkingPanel", lines: 152, description: "Animated thinking state display with chain-of-thought visualization.", tags: ["React"] },
      { name: "ChartDiagram", lines: 146, description: "Chart rendering component supporting bar, line, pie, and scatter charts.", tags: ["React"] },
      { name: "MermaidDiagram", lines: 108, description: "Mermaid diagram renderer with live preview and error handling.", tags: ["React"] },
      { name: "ConversationHistoryPanel", lines: 112, description: "Sidebar panel for browsing past conversations with search.", tags: ["React"] },
      { name: "ThinkingIndicator.tsx", lines: 79, description: "Animated thinking indicator for loading states.", tags: ["React"] },
      { name: "MessageActions", lines: 40, description: "Action buttons for messages (copy, edit, delete, share).", tags: ["React"] },
      { name: "AIChatSidebar/types.ts", lines: 145, description: "TypeScript types for AI chat sidebar components.", tags: ["React", "Types"] },
      { name: "AIChatSidebar/helpers.ts", lines: 27, description: "Helper utilities for AI chat sidebar.", tags: ["React", "Utils"] },
  ...
  },
  {
    ...
    components: [
      { name: "SettingsPanel", lines: 1022, description: "Main settings container with all configuration sections and theme support.", tags: ["React", "Main"] },
      { name: "LLMProviderSettings", lines: 929, description: "AI model provider configuration (Gemini, Claude, GPT, Ollama, Groq).", tags: ["React", "AI"] },
      { name: "AutomationSettings", lines: 820, description: "Automation & scheduling settings with task management and permissions.", tags: ["React"] },
      { name: "SyncSettings", lines: 635, description: "WiFi/P2P sync configuration for mobile pairing with QR codes.", tags: ["React"] },
      { name: "UpdatesSettings", lines: 538, description: "Auto-update configuration and version info with changelog.", tags: ["React"] },
      { name: "PermissionSettings", lines: 697, description: "Command permission management by risk level (LOW/MEDIUM/HIGH/CRITICAL).", tags: ["React", "Security"] },
      { name: "PluginSettings", lines: 408, description: "Plugin management UI with install/enable/disable from marketplace.", tags: ["React"] },
      { name: "McpSettings", lines: 486, description: "Model Context Protocol settings for external tools and services.", tags: ["React"] },
      { name: "ProxyFirewallManager", lines: 373, description: "Advanced proxy & firewall rules management with presets.", tags: ["React"] },
      { name: "ThemeSettings", lines: 255, description: "Visual theme configuration with custom gradients and presets.", tags: ["React"] },
      { name: "ExtensionSettings", lines: 186, description: "Browser extension settings with enable/disable toggles.", tags: ["React"] },
      { name: "StartupSetupUI", lines: 635, description: "First-run setup wizard with feature tour and preferences.", tags: ["React"] },
      { name: "ApiKeysSettings", lines: 104, description: "API key configuration UI with secure storage indicators.", tags: ["React"] },
      { name: "PerformanceSettings", lines: 91, description: "Performance tuning options (GPU, memory, caching).", tags: ["React"] },
      { name: "AutofillSettings", lines: 114, description: "Form autofill configuration with secure storage.", tags: ["React"] },
      { name: "ProxySettings", lines: 81, description: "Proxy server configuration with auth support.", tags: ["React"] },
      { name: "SearchEngineSettings", lines: 39, description: "Default search engine configuration with custom engines.", tags: ["React"] },
      { name: "UserAgentSettings", lines: 48, description: "Custom user agent strings for browser fingerprinting.", tags: ["React"] },
      { name: "KeyboardShortcutSettings", lines: 64, description: "Keyboard shortcut customization with presets.", tags: ["React"] },
      { name: "BackendSettings", lines: 77, description: "Backend service configuration for P2P sync.", tags: ["React"] },
    ]
  },
  {
    title: "Browser Core",
    ...
    components: [
      { name: "BrowserViewContainer", lines: 132, description: "WebView container management with secure context and sandboxing.", tags: ["React"] },
      { name: "TitleBar", lines: 177, description: "Custom window title bar with traffic lights and window controls.", tags: ["React", "macOS"] },
      { name: "TabManager", lines: 254, description: "Tab lifecycle management with create, close, restore.", tags: ["React"] },
      { name: "VirtualizedTabBar", lines: 317, description: "High-performance virtualized tab bar for 100+ tabs.", tags: ["React"] },
      { name: "SpotlightSearchOverlay", lines: 303, description: "Spotlight-style universal search overlay with fuzzy matching.", tags: ["React"] },
      { name: "QuickNavOverlay", lines: 212, description: "Quick navigation with keyboard shortcuts and recent items.", tags: ["React"] },
      { name: "TabSwitcherOverlay", lines: 78, description: "Visual tab switcher (Cmd+Shift+]) with thumbnails.", tags: ["React"] },
      { name: "ClipboardManager", lines: 85, description: "Clipboard history with sync support and search.", tags: ["React"] },
      { name: "HistoryPanel", lines: 48, description: "Browsing history view with search and filtering.", tags: ["React"] },
      { name: "WelcomeScreen", lines: 774, description: "First-time user welcome with feature tour and setup.", tags: ["React"] },
      { name: "UnifiedSearch", lines: 402, description: "Universal search across all content types (web, history, bookmarks).", tags: ["React"] },
      { name: "LoginPrompt", lines: 18, description: "Authentication login dialog with secure credential storage.", tags: ["React"] },
    ]
  },
  {
    ...
    components: [
      ...
      { name: "CrossAppOCR", lines: 370, description: "Cross-application OCR & click for external apps.", tags: ["React"] },
      { name: "PhoneCamera", lines: 105, description: "Phone camera integration for document capture.", tags: ["React"] },
      { name: "ClickPermissionModal", lines: 222, description: "Permission dialog for click actions.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      { name: "PDFGenerationPanel", lines: 358, description: "PDF creation interface with template selection and preview.", tags: ["React"] },
      { name: "PDFWorkspace", lines: 266, description: "PDF editing workspace with annotation support.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      { name: "WiFiSyncService", lines: 530, description: "Real-time WebSocket sync with QR code pairing over local network.", tags: ["Node.js", "Sync"] },
      { name: "P2PFileSyncService.ts", lines: 670, description: "Peer-to-peer file sync service for large files.", tags: ["Node.js", "Sync"] },
      { name: "CloudSyncService.ts", lines: 530, description: "Cloud-based sync service with conflict resolution.", tags: ["Node.js", "Sync"] },
      { name: "SyncMethodManager.ts", lines: 259, description: "Manages sync methods (WiFi, Cloud, P2P) with fallbacks.", tags: ["Node.js", "Sync"] },
      { name: "FirebaseSyncService.ts", lines: 245, description: "Firebase backend sync for real-time updates.", tags: ["Node.js", "Sync"] },
      { name: "ContactSyncService.ts", lines: 132, description: "Contact synchronization across devices.", tags: ["Node.js", "Sync"] },
      { name: "P2PSyncManager", lines: 185, description: "Peer-to-peer sync manager UI with bandwidth control.", tags: ["React"] },
      { name: "CloudSyncConsent", lines: 45, description: "Cloud sync permission dialog.", tags: ["React"] },
    ]
  },
  {
    title: "LLM Providers",
  ...
  },
  {
    ...
    components: [
      ...
      { name: "SkillLoader.ts", lines: 160, description: "Dynamic skill/command loader for AI.", tags: ["Node.js"] },
      ...
      { name: "FirebaseService.ts", lines: 204, description: "Firebase initialization and configuration.", tags: ["Node.js"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "WebStore", lines: 107, description: "Plugin/extension marketplace UI with categories.", tags: ["React"] },
    ]
  },
  {
    ...
    components: [
      ...
      { name: "Security.ts", lines: 671, description: "Command validation, shell sanitization, XSS prevention, URL validation.", tags: ["Node.js", "Security"] },
      { name: "AICommandParser.ts", lines: 600, description: "AI command extraction, JSON parsing, bracket format support.", tags: ["Node.js", "AI"] },
      ...
      { name: "BrowserAI.ts", lines: 384, description: "Browser-specific AI orchestration and state management.", tags: ["Node.js", "AI"] },
  ...
  },
  {
    ...
    components: [
      { name: "AdminDashboard", lines: 169, description: "Admin control panel for system management.", tags: ["React"] },
      { name: "CodingDashboard", lines: 204, description: "Development workspace with code editor.", tags: ["React"] },
      { name: "WorkspaceDashboard", lines: 158, description: "General workspace hub.", tags: ["React"] },
      { name: "PresentonStudio", lines: 395, description: "Presentation creation studio.", tags: ["React"] },
      { name: "MediaStudio", lines: 168, description: "Media management and editing.", tags: ["React"] },
      { name: "AIFeatureDemo", lines: 472, description: "Interactive AI feature demonstrations.", tags: ["React", "AI"] },
      { name: "LandingPage", lines: 383, description: "Marketing landing page component.", tags: ["React"] },
      { name: "Documentation", lines: 269, description: "Built-in documentation viewer.", tags: ["React"] },
      { name: "CapabilitiesPanel", lines: 74, description: "Browser capabilities display.", tags: ["React"] },
    ]
  },
  {
    ...
    components: [
      { name: "DinoGame", lines: 242, description: "Offline dinosaur game (Chrome-style).", tags: ["React", "Game"] },
      { name: "NoNetworkGame", lines: 139, description: "No-internet game for offline pages.", tags: ["React", "Game"] },
      { name: "MediaSuggestions", lines: 43, description: "Content suggestions based on browsing.", tags: ["React"] },
      { name: "PasswordManager", lines: 382, description: "Saved passwords manager with secure storage.", tags: ["React"] },
      { name: "UnifiedCartPanel", lines: 66, description: "Shopping cart aggregator.", tags: ["React"] },
      { name: "QuickNavOverlay", lines: 212, description: "Quick navigation overlay.", tags: ["React"] },
    ]
  },
];
    ...
    <div className="space-y-24">
      ...
      >
        ...
        <div className="bg-black/40 rounded-xl p-4 font-mono text-sm">
          ...
          <div className="text-sky-400">cd comet-browser && node scripts/component-scanner.js --all</div>
