...
const desktopCategories: CategorySection[] = [
  {
    ...
    components: [
      { name: "AIChatSidebar", lines: 8392, description: "Main chat interface with real-time streaming, thinking indicators, command execution, and scheduling.", tags: ["React", "AI", "Main"] },
      { name: "AIUtils", lines: 956, description: "Utility functions for PDF generation, image handling, command formatting, and secure storage.", tags: ["React", "Utils"] },
      { name: "AIConstants", lines: 489, description: "AI instructions, commands, capabilities, language maps, and system prompts.", tags: ["React", "Config"] },
      ...
      { name: "ClickPermissionModal", lines: 608, description: "Permission dialog for click actions with risk assessment.", tags: ["React"] },
      ...
      { name: "ThinkingPanel", lines: 173, description: "Animated thinking state display with chain-of-thought visualization.", tags: ["React"] },
      ...
      { name: "AIChatSidebar/types.ts", lines: 167, description: "TypeScript types for AI chat sidebar components.", tags: ["React", "Types"] },
      { name: "AIChatSidebar/helpers.ts", lines: 37, description: "Helper utilities for AI chat sidebar.", tags: ["React", "Utils"] },
      { name: "AICommandOutput.ts", lines: 220, description: "AI command output rendering and formatting.", tags: ["React", "AI"] },
      { name: "SmartMessageContent", lines: 789, description: "Renders AI messages with markdown, code highlighting, and OCR payoffs.", tags: ["React", "AI"] },
      { name: "AIThinkingAnimation", lines: 520, description: "Animated AI thinking state with typed reasoning steps.", tags: ["React", "AI"] },
      { name: "AISessionVisualization", lines: 129, description: "Visualizes the current AI session and action chain.", tags: ["React", "AI"] },
      { name: "ResearchReport", lines: 302, description: "Renders completed deep-research reports with sources.", tags: ["React", "AI"] },
      { name: "ResearchExecutionCard", lines: 209, description: "Live progress card for deep-research executions.", tags: ["React", "AI"] },
      { name: "QuestionCard", lines: 153, description: "Interactive question card for assistant clarifications.", tags: ["React", "AI"] },
      { name: "AutomationPlanApproval", lines: 411, description: "Pre-execution automation plan with risk assessment per step.", tags: ["React", "Security", "Automation"] },
      { name: "useAIActionSecurityManager", lines: 706, description: "Hook enforcing the AI action security pipeline for sidebar actions.", tags: ["React", "Security", "AI"] },
    ]
  },
  {
    ...
    components: [
      { name: "SettingsPanel", lines: 1263, description: "Main settings container with all configuration sections and theme support.", tags: ["React", "Main"] },
      ...
      { name: "AutomationSettings", lines: 1034, description: "Automation & scheduling settings with task management and permissions.", tags: ["React"] },
      { name: "SyncSettings", lines: 706, description: "WiFi/P2P sync configuration for mobile pairing with QR codes.", tags: ["React"] },
      { name: "UpdatesSettings", lines: 571, description: "Auto-update configuration and version info with changelog.", tags: ["React"] },
      ...
      { name: "McpSetupGuide", lines: 339, description: "Interactive MCP server setup for Claude Desktop with auto-configure.", tags: ["React", "AI"] },
      { name: "McpApprovalPopup", lines: 177, description: "Native approval popup for MCP tool permission prompts.", tags: ["React", "Security"] },
      { name: "SettingsApprovalPanel", lines: 173, description: "Approval panel for agent and settings permission requests.", tags: ["React", "Security"] },
      ...
      { name: "ExtensionSettings", lines: 495, description: "Browser extension settings with enable/disable toggles.", tags: ["React"] },
      { name: "StartupSetupUI", lines: 960, description: "First-run setup wizard with feature tour and preferences.", tags: ["React"] },
      { name: "ApiKeysSettings", lines: 318, description: "API key configuration UI with secure storage indicators.", tags: ["React"] },
      { name: "PerformanceSettings", lines: 92, description: "Performance tuning options (GPU, memory, caching).", tags: ["React"] },
      { name: "AutofillSettings", lines: 255, description: "Form autofill configuration with secure storage.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "VirtualizedTabBar", lines: 336, description: "High-performance virtualized tab bar for 100+ tabs.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "ClickPermissionModal", lines: 608, description: "Permission dialog for click actions.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "ExtensionManager", lines: 66, description: "Browser extension management with hot-reload.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "AICommandParser.ts", lines: 867, description: "AI command extraction, JSON parsing, bracket format support.", tags: ["Node.js", "AI"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "PasswordManager", lines: 503, description: "Saved passwords manager with secure storage.", tags: ["React"] },
