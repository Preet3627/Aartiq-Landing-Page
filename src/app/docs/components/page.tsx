...
const desktopCategories: CategorySection[] = [
  {
    ...
    components: [
      { name: "AIChatSidebar", lines: 4975, description: "Main chat interface with real-time streaming, thinking indicators, command execution, and scheduling.", tags: ["React", "AI", "Main"] },
      { name: "AIUtils", lines: 1090, description: "Utility functions for PDF generation, image handling, command formatting, and secure storage.", tags: ["React", "Utils"] },
      { name: "AIConstants", lines: 666, description: "AI instructions, commands, capabilities, language maps, and system prompts.", tags: ["React", "Config"] },
      { name: "SchedulingModal", lines: 496, description: "Modal for scheduling AI tasks with cron builder, model selection, and notification options.", tags: ["React", "AI"] },
      { name: "AISetupGuide", lines: 827, description: "Interactive wizard for configuring AI providers and API keys with validation.", tags: ["React", "Setup"] },
      { name: "SchedulingIntentDetector", lines: 369, description: "Natural language scheduling detection with cron expression extraction.", tags: ["React", "AI"] },
      { name: "SecureDOMReader", lines: 361, description: "Secure DOM reading with XSS prevention and structured data extraction.", tags: ["React"] },
      { name: "DOMSearchDisplay", lines: 360, description: "Visual DOM search results with element highlighting and metadata.", tags: ["React"] },
      ...
      { name: "ClickPermissionModal", lines: 232, description: "Permission dialog for click actions with risk assessment.", tags: ["React"] },
      { name: "CollapsibleOCRMessage", lines: 225, description: "Expandable OCR results display with raw text view and confidence scores.", tags: ["React", "OCR"] },
      ...
      { name: "ThinkingPanel", lines: 153, description: "Animated thinking state display with chain-of-thought visualization.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      { name: "SettingsPanel", lines: 1099, description: "Main settings container with all configuration sections and theme support.", tags: ["React", "Main"] },
      { name: "LLMProviderSettings", lines: 1061, description: "AI model provider configuration (Gemini, Claude, GPT, Ollama, Groq).", tags: ["React", "AI"] },
      { name: "AutomationSettings", lines: 932, description: "Automation & scheduling settings with task management and permissions.", tags: ["React"] },
      ...
      { name: "PermissionSettings", lines: 698, description: "Command permission management by risk level (LOW/MEDIUM/HIGH/CRITICAL).", tags: ["React", "Security"] },
      { name: "PluginSettings", lines: 422, description: "Plugin management UI with install/enable/disable from marketplace.", tags: ["React"] },
      { name: "McpSettings", lines: 525, description: "Model Context Protocol settings for external tools and services.", tags: ["React"] },
      ...
      { name: "StartupSetupUI", lines: 756, description: "First-run setup wizard with feature tour and preferences.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "TitleBar", lines: 178, description: "Custom window title bar with traffic lights and window controls.", tags: ["React", "macOS"] },
      { name: "TabManager", lines: 255, description: "Tab lifecycle management with create, close, restore.", tags: ["React"] },
      { name: "VirtualizedTabBar", lines: 318, description: "High-performance virtualized tab bar for 100+ tabs.", tags: ["React"] },
      { name: "SpotlightSearchOverlay", lines: 305, description: "Spotlight-style universal search overlay with fuzzy matching.", tags: ["React"] },
      ...
      { name: "WelcomeScreen", lines: 319, description: "First-time user welcome with feature tour and setup.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "ClickPermissionModal", lines: 232, description: "Permission dialog for click actions.", tags: ["React"] },
  ...
  },
  {
    ...
    components: [
      { name: "WiFiSyncService", lines: 497, description: "Real-time WebSocket sync with QR code pairing over local network.", tags: ["Node.js", "Sync"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "Security.ts", lines: 540, description: "Command validation, shell sanitization, XSS prevention, URL validation.", tags: ["Node.js", "Security"] },
      { name: "AICommandParser.ts", lines: 657, description: "AI command extraction, JSON parsing, bracket format support.", tags: ["Node.js", "AI"] },
  ...
  },
  {
    ...
    components: [
      ...
      { name: "LandingPage", lines: 216, description: "Marketing landing page component.", tags: ["React"] },
